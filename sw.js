...
const APP_SHELL = [
  ...
  "./js/orte.js?v=162",
  "./js/nachsuchen.js?v=101",
  "./js/import-export.js?v=141",
  "./js/mobile.js",
  "./js/components/searchDropdown.js?v=2",
  "./js/components/personAutocomplete.js?v=1",
  "./js/components/orteKarte.js?v=118",
  "./js/components/orteAuswahl.js?v=109",
  "./js/services/hashtagService.js?v=115",
  "./js/services/personenAutocompleteService.js?v=1",
  ...
  "./js/st-peter-mitterberg.js?v=119",
  "./js/key-dates.js?v=3",
