const CACHE_NAME = "dp-jagd-shell-v215";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=2",
  ...
  "./js/components/a4PreviewZoom.js?v=2",
