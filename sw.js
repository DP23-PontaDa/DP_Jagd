const CACHE_NAME = "dp-jagd-shell-v93";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./js/services/abschussService.js?v=89",
  "./js/services/rechnungService.js?v=88",
  "./js/services/rechnungPrintService.js?v=88",
  "./js/services/rechnungsvorlageService.js",
  "./js/services/berechtigungService.js?v=93",
  "./js/services/benutzerverwaltungService.js?v=93",
